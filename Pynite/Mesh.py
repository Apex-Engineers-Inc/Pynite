...
class RectangleMesh(Mesh):
    ...
    def __init__(self, mesh_size: float, width: float, height: float, thickness: float, material_name: str, model: FEModel3D, kx_mod: float = 1.0, ky_mod: float = 1.0, origin: list[float] | tuple[float, float, float] = (0, 0, 0), plane: str = 'XY', x_control: list[float] | None = None, y_control: list[float] | None = None, start_node: str = 'N1', start_element: str = 'Q1', element_type: str = 'Quad') -> None:
        """
        ...
        origin : list[float] | tuple[float, float, float], optional
...
class AnnulusMesh(Mesh):
    ...
    def __init__(self, mesh_size: float, outer_radius: float, inner_radius: float, thickness: float, material_name: str, model: FEModel3D, kx_mod: float = 1,
        ky_mod: float = 1, origin: list[float] | tuple[float, float, float] = (0, 0, 0), axis: str = 'Y', start_node: str = 'N1', start_element: str = 'Q1') -> None:
...
class AnnulusTransRingMesh(Mesh):
    ...
    def __init__(self, outer_radius: float, inner_radius: float, num_inner_quads: int, thickness: float, material_name: str, model: FEModel3D,
                 kx_mod: float = 1, ky_mod: float = 1, origin: list[float] | tuple[float, float, float] = (0, 0, 0), axis: str = 'Y', start_node: str = 'N1',
...
class FrustrumMesh(AnnulusMesh):
    ...
    def __init__(self, mesh_size: float, large_radius: float, small_radius: float, height: float, thickness: float, material_name: str, model: FEModel3D, kx_mod: float = 1, ky_mod: float = 1,
                 origin: list[float] | tuple[float, float, float] = (0, 0, 0), axis: str = 'Y', start_node: str = 'N1', start_element: str = 'Q1') -> None:
...
class CylinderMesh(Mesh):
    ...
    element_type : string, optional
        The type of element to use for the mesh: 'Quad' or 'Rect' (plate). The default is 'Quad'.
    """

    def __init__(self, mesh_size: float, radius: float, height: float, thickness: float, material_name: str, model: FEModel3D, kx_mod: float = 1, ky_mod: float = 1,origin: list[float] | tuple[float, float, float] = (0, 0, 0), axis: str = 'Y', start_node: str = 'N1', start_element: str = 'Q1', num_elements: int | None = None, element_type: Literal['Quad', 'Rect'] = 'Quad') -> None:
